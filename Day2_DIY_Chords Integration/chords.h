...
// Chords parameters
char  *chords_endpoint = "http://ec2-3-13-105-177.us-east-2.compute.amazonaws.com/instruments/10";   // Your CHORDS portal URL
...
int   instrument_id = 10;                            // Your instrument id
uint8 is_test = 0u;
